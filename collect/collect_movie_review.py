...
from selenium import webdriver  # 고급개발된 web에서 데이터 수집할때 사용
...
#print(result.text)  # 소스코드를 가져왔는지 확인
...
title = doc.select("span.txt_tit")[1].text.strip()  # 영화 제목 수집    .text는 헤더값들을 지움
